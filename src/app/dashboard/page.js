...
export default function Dashboard() {
  ...
  if (password !== process.env.NEXT_PUBLIC_ADMIN_PASSWORD) {
    ...
    const sameLoc = (x, y) => { return x.latitude == y.latitude && x.longitude == y.longitude && x.range == y.range && x.operators == y.operators && x.active == y.active }
    return (
      <div className="grid items-center justify-items-center min-h-screen place-content-center font-[family-name:var(--font-geist-sans)]">
        ...
        <div className="text-center" id="Locations">
          ...
          <table className="table-auto overflow-auto">
            <thead>
              <tr>
                ...
                <th className="p-3 text-center text-SM font-medium text-gray-300 uppercase">Operator(s)</th>
          ...
          }}><Image src ='/plus.svg' width={32} height={32} alt='plus'/>New Location</button>
          ...
          }}><Image src ='/disk.svg' width={32} height={32} alt='disk'/>Save changes</button>
        ...
        <div className='flex flex-col items-center' id="ChangePassword">
          ...
          <div className="grid grid-cols-2 gird-rows-2 grid-flow-row items-center justify-items-center">
            ...
            <label className="text-lg font-semibold mb-2">Confiem Password</label>
